...
set({ "n", "x" }, "<C-M-d>", function() mc.matchSkipCursor(1) end, { desc = "Skip cursor at next match" })
set({ "n", "x" }, "<C-M-S-d>", function() mc.matchSkipCursor(-1) end, { desc = "Skip cursor at prev match" })
